...
<div class="slider">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/SLIDER AVACADO.jpg" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="img/SLIDER IMAGE BIG BASKET.jpg" class="d-block w-100" >
    </div>
    <div class="carousel-item">
...
<!-- -----------------------------new products---------------->
<section id="rare-fruit-section" class="new-products" >
	<div class="container">
	<div class="title-box">
	<h2>Rare Fruits</h2>		
	</div>
	<div class="row">
		<?php 
	$run = mysqli_query($con,"SELECT * FROM products WHERE product_cat = 3 and active=1");
