              ...
              <div class="panel-body">
                <form action="add-process.php" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" name="pname" class="form-control" placeholder="Product Title" required autocomplete="off">
                  </div>
                    <div class="form-group">
                    <label>Price</label>
                    <input type="number" name="pprice" class="form-control" placeholder="product price" required autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label>Product Discription</label>
                    <textarea name="pdesc" class="form-control" placeholder="Product Discription" required autocomplete="off"></textarea>
                  </div>
                   <div class="form-group">
                    <label>Product Image</label>
                    <input type="file" name="pimage" class="form-control" placeholder="Product Image" required autocomplete="off">
                  </div>
                  <div class="checkbox">
                       <label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="pqty" class="form-control" placeholder="Add product in stock in kgs..." required>
                  </div>
                  <div class="form-group">
                    <label><span class="glyphicon glyphicon-arrow-left" aria-hidden="true">&nbsp</span>product category</label>
                    <input type="number" name="pcat" class="form-control" placeholder="add product category..." autocomplete="off"  min=1 max=6  required>
                  </div>
                   <div class="form-group">
                    <label>product Discount</label>
                    <input type="number" name="pdiscount" class="form-control" autocomplete="off" value="0" placeholder="put the discount in product if you want..."  min=0 max = 100>
                  </div>
